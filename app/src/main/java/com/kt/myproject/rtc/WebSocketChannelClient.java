...
import com.kt.myproject.utils.AsyncHttpURLConnection;
...
public class WebSocketChannelClient {
    ...
    public void connect(final String wsUrl, final String postUrl) {
        ...
        try {
            ws.connect(new URI(wsServerUrl), (WebSocket.WebSocketConnectionObserver) wsObserver);
