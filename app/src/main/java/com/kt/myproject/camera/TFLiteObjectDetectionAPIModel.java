...
public class TFLiteObjectDetectionAPIModel implements Classifier {
    ...
    private static MappedByteBuffer loadModelFile(AssetManager assets, String modelFilename)
        ...
        Log.d("modelfile", String.format("startOffset %s", startOffset));
        Log.d("modelfile", String.format("declaredLength %s", declaredLength));
    ...
    public static Classifier create(
        ...
        InputStream labelsInput = new FileInputStream(labelFile);
        BufferedReader br = new BufferedReader(new InputStreamReader(labelsInput));
        String line;
        while ((line = br.readLine()) != null) {
            d.labels.add(line);
        ...
        try {
            ...
            MappedByteBuffer mappedByteBuffer = inputStream
                    .getChannel()
                    .map(FileChannel.MapMode.READ_ONLY, 0, modelFile.length());
            d.tfLite = new Interpreter(mappedByteBuffer);
        } catch (Exception e) {
            throw new RuntimeException(e);
        }
