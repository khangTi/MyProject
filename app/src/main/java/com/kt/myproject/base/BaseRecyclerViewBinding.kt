...
abstract class BaseRecyclerAdapter<T, VB : ViewBinding> : RecyclerView.Adapter<RecyclerView.ViewHolder>() {
    ...
    protected abstract fun View.onBindModel(model: T, position: Int, view: VB)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        binding = getBinding(parent.context, parent)
    ...
    override fun onBindViewHolder(viewHolder: RecyclerView.ViewHolder, position: Int) {
        ...
        viewHolder.itemView.onBindModel(model, position, binding)
